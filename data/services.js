...
export const flyerMainServices = [
  ...
  },
  {
    ...
    priceDisplay: "₦5,000",
    period: "3 Months",
    description: "4GB file uploads, faster downloads, voice-to-text, animated emoji, and star badge for 3 months.",
    featured: false,
    popular: true,
    badge: "3 Months",
    brandColor: "#24A1DE",
    ...
    features: ["4GB file upload limit", "Double limits across channels", "Star badge profile", "3 Months active access"]
  },
  {
    id: "tg-premium-6m",
    ...
    priceDisplay: "₦9,500",
    period: "6 Months",
    description: "4GB file uploads, faster downloads, voice-to-text, animated emoji, and star badge for 6 months.",
    featured: false,
    popular: false,
    badge: "6 Months",
    brandColor: "#24A1DE",
    icon: "telegram",
    logoUrl: "/logos/telegram.svg",
    features: ["4GB file upload limit", "Double limits across channels", "Star badge profile", "6 Months active access"]
  },
  {
    id: "tg-premium-1y",
    ...
    priceDisplay: "₦18,000",
    period: "1 Year",
    description: "Full annual Telegram Premium subscription with maximum savings and instant activation.",
    featured: false,
    popular: false,
    badge: "1 Year Value",
    brandColor: "#24A1DE",
    icon: "telegram",
    logoUrl: "/logos/telegram.svg",
    features: ["4GB file upload limit", "Double limits across channels", "Star badge profile", "Full 12 Months access"]
  },
  {
    id: "supergrok",
    name: "Supergrok",
